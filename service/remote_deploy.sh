#!/bin/bash
# Deploy LEDiff to a remote GPU instance from your local machine.
#
# Usage:
...
# The service keeps running in tmux session "lediff" on the remote.
# Reattach with: ssh <host> -t tmux attach -t lediff

set -euo pipefail

SERVICE_NAME="lediff-service"
REPO_URL="https://github.com/alxBO/lediff-service.git"
TMUX_SESSION="lediff"
REMOTE_WORKDIR="~"
